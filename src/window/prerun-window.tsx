                ...
                <div class="flex flex-row mb-4 -mt-4 items-center">
                    <div class="btn btn-accent" onClick={login}>
                        ...
                        >
                            <path
                                fill-rule="evenodd"
                                d="M7.5 6a4.5 4.5 0 1 1 9 0 4.5 4.5 0 0 1-9 0ZM3.751 20.105a8.25 8.25
...
function Play(props: { class?: string }) {
    ...
    async function onPlay() {
        if (configChanged) {
            ...
            try {
                nonSerializableStore.loadedBundle!.bundle = await emulators.bundleUpdateConfig(
                    bundle,
                    config,
                );
    ...
    return (
        <div class={props.class + " cursor-pointer"} onClick={onPlay}>
            <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
            ...
            >
                ...
                <path
                    stroke-linecap="round"
                    stroke-linejoin="round"
                    d="M15.91 11.672a.375.375 0 010
