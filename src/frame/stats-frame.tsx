...
export function StatsFrame() {
    ...
    const driveSpeedMb =
        stats.driveRecvTime / 1000 > 1
            ? Math.round((driveRecvMb / stats.driveRecvTime) * 1000 * 100) / 100
            : 0;
    return (
        <div class="stats-frame frame-root items-start px-4">
                ...
                <table class="table table-compact w-full">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>HDD RECV/s</td>
                            <td>
                                {driveRecvMb}Mb (~{driveSpeedMb}Mb/s)
                            </td>
                        </tr>
                        <tr>
                            <td>HDD SENT/s</td>
                        ...
                        <tr>
                            <td>HDD Cache</td>
                            <td>
                                {Math.round((stats.driveCacheUsed / 1024 / 1024) * 100) / 100}Mb
                            </td>
                        </tr>
                        <tr>
                            <td>HDD Cache Hit/Miss</td>
                            <td>
                                {stats.driveCacheHit} / {stats.driveCacheMiss}
                            </td>
                        </tr>
                    </tbody>
                </table>
